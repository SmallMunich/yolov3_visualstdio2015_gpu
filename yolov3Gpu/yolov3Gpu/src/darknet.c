...
int main(int argc, char **argv)
{
	...
	argv[3] = "..\\yolov3Gpu\\data\\voc.data";  
	argv[4] = "..\\yolov3Gpu\\cfg\\yolov3.cfg";
	argv[5] = "..\\yolov3Gpu\\cfg\\yolov3.weights";
	//argv[6] = "..\\yolov3Gpu\\data\\highspeed.mp4";
	argv[6] = "..\\yolov3Gpu\\data\\giraffe.jpg";
